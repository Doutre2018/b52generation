...
public:
	...
	void flipTextBrightness(ConsoleColor & color);
	void flipBackgroundBrightness(ConsoleColor & color);
	void flipOpaqueBrightness(ConsoleColor & color);
	void darkerText(ConsoleColor & color);
	void darkerBackground(ConsoleColor & color);
	void darkerOpaque(ConsoleColor & color);
	void lighterText(ConsoleColor & color);
	void lighterBackground(ConsoleColor & color);
	void lighterOpaque(ConsoleColor & color);
	void darkestText(ConsoleColor & color);
	void darkestBackground(ConsoleColor & color);
	void darkestOpaque(ConsoleColor & color);
	void lightessText(ConsoleColor & color);
	void lightessBackground(ConsoleColor & color);
	void lightessOpaque(ConsoleColor & color);
